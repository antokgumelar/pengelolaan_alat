...
<div class="content">
    <div class="container">
        ...
        <div class="input-group">
            <form action="cari_pinjam.php" method="get" class="form-container">
                ...
                <div class="input-group-append">
                    ...
                    <button class="btn btn-outline-primary" type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Konfirmasi Peminjaman/Pengembalian" onclick="window.location.href='form_update.php'">
                    <i class='bi bi-arrow-clockwise'></i>
                    </button>
                    <button class="btn btn-outline-primary" type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Input Kondisi Barang" onclick="window.location.href='form_kembali.php'">
    ...
    <div class="container">
        ...
        <?php
            ...
            $sql = "SELECT * FROM pinjam_alat 
                    WHERE nama_pegawai LIKE ? OR kode_alat LIKE ? OR nama_alat LIKE ? OR id_pinjam LIKE ?
