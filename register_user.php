<?php
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['register_user'])) {
            $email = filter_input(INPUT_POST, 'email_akun_pengguna', FILTER_SANITIZE_EMAIL);
            $password = $_POST['password_akun_pengguna'] ?? '';
            ...
            // Simpan ke database
            $stmt = $pdo->prepare('INSERT INTO akun_pengguna (email_akun_pengguna, password_akun_pengguna) VALUES (:email_akun_pengguna, :password_akun_pengguna)');
            $stmt->execute([
                'email_akun_pengguna' => $email,
                'password_akun_pengguna' => $hashedPassword
            ]);
        ...
        <div class="login-container">
            ...
            <form method="POST" action="">
                    <div class="form-floating">
                        <input type="email" class="form-control" name="email_akun_pengguna" placeholder="Username" required>
