...
<html lang="en">
  <head>
    ...
    <style>
        ...
        html{
            background-image:url("backgroundfix.jpg");
  ...
  <body>
        <!-- <div class="image-container">
            <img src="backgroundfix.jpg" alt="Contoh Gambar" class="responsive-image">
        </div> -->
        <div class="login-container">
            ...
            <form id="loginForm" method="POST">
                    <div class="form-floating">
                        <input type="email" class="form-control" id="email_akun" name="email_akun" placeholder="Username" required>
                        <label for="email_akun">Username</label>
                    </div>
                    <div class="form-floating">
                        <input type="password" class="form-control" id="password_akun" name="password_akun" placeholder="Password" required>
