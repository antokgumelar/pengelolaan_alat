        ...
        <form action="input_pegawai.php" method="POST" enctype="multipart/form-data">
                <div class="mb-2">
                    <div class="form-floating mb-2">
                        <input type="number" id="nik_pegawai" name="nik_pegawai" class="form-control" placeholder="Masukkan NIK Pegawai" autocomplete="off">
                        <label for="nik_pegawai">NIK Pegawai</label>
                    </div>
                    <div class="form-floating mb-2">
                        <input type="text" id="nama_pegawai" name="nama_pegawai" class="form-control" placeholder="Masukkan Nama Pegawai" autocomplete="off">
                        <label for="nama_pegawai">Nama Pegawai</label>
                    </div>
                    <div class="form-floating mb-2">
                        <input type="number" id="no_wa_pegawai" name="no_wa_pegawai" class="form-control" placeholder="Masukkan No Whatsapp Pegawai" autocomplete="off">
                        <label for="no_wa_pegawai">No Whatsapp Pegawai</label>
                    </div>
                    <button type="submit" class="btn btn-primary">Tambahkan Peminjam</button>
                </div>
            </form>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr class='data-row'>
                                    ...
                                    <a onclick=window.location.href='hapus_pegawai.php?nik_pegawai=" . $row['nik_pegawai'] . "'>
                                        ...
                                        <a onclick=window.location.href='cari_pegawai_edit.php?nik_pegawai=". $row['nik_pegawai']. "'>
